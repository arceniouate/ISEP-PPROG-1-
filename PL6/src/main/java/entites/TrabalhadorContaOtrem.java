...
public class TrabalhadorContaOtrem extends  Trabalhador {
    /**
     ...
     */
    public TrabalhadorContaOtrem(String nome, String morada, double rT, double oR, String empresa) {
